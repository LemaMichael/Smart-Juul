...
#define CW1    0x1FE30CF // Forward (Up Arrow)
#define CW2    0x1FE8877 // Backward (Down Arrow)
#define CW3    0x1FE08F7 // Turn Right (Right Arrow)
#define CW4    0x1FE9867 // Turn Left (Left Arrow)
#define CW5    0x1FED827 // Move Arm Up (Reverse Button)
#define CW6    0x1FE18E7 // Move Arm Down (Forward Button)
#define CW7    0x1FEE01F // Close Clamp (Play Button)
#define CW8    0x1FED02F // Open Clamp (Pause Button)
#define CW9    0x1FEF00F // Clamp Hold (Audio/Search Button)
#define CW10   0x1FE6897 // Release Clamp (Mute Button)
